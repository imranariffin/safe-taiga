...
public class ScriptManager {
	...
	public static String insertIntoImageDbUserImageRequest(String ipAddress, float[][][] partitioningRGBArray) {
		String script = "INSERT INTO imagedb_user_image_request_float (request_ip, pixel_rgb) VALUES ('" + ipAddress
				+ "', " + convertTripleArrayToQueryString(partitioningRGBArray) + ");";
		return script;
	}
	...
	public static String findMatchingImageDataBruteForce(float[][][] partitioningRGBArray) {
		// sample
		// SELECT pixel_rgb[1][1][1] FROM imagedb_user_image_request WHERE
		// pixel_rgb[1][1][1] BETWEEN (100-25) AND (100+25) ORDER BY
		// pixel_rgb[1][1][1];
	...
	public static String convertTripleArrayToQueryString(float[][][] tripleArray) {
		/**
		 * create string for the RGBs
		 */
	...
	public static String findMatchingImageDataRandomized(float[][][] partitioningRGBArray) {
		String script = "SELECT name, episode, panel FROM imagedb_anime_rgb WHERE ";
	...
	public static String findMatchingImageDataRandomizedV2(float[][][] partitioningRGBArray) {
		String script = "SELECT name, episode, panel FROM imagedb_anime_rgb WHERE ";
	...
	public static String findMatchingImageDataIncremental(int x, int y, int z, float value) {
		String script = "SELECT name, episode, panel FROM imagedb_anime_rgb WHERE ";
	...
	public static String findMatchingImageDataIncrementalRGB(int x, int y, float[] array) {
		String script = "SELECT name, episode, panel FROM imagedb_anime_rgb WHERE ";
